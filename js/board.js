const requestURL = 'https://github.com/rogue-towne/glendalechamber/blob/main/data/contactData.json';
...
const requestURL2 = 'https://github.com/rogue-towne/glendalechamber/blob/main/data/faces.json';
fetch(requestURL2)
